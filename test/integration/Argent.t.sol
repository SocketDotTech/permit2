...
contract ArgentTest is Test {
    ...
    WalletFactory walletFactory =
        WalletFactory(0x536384FCd25b576265B6775F383D5ac408FF9dB7);
    ...
    function testIsValidSignature() public {
        ...
        vm.prank(address(1));
        IERC1271 wallet = walletFactory.createCounterfactualWallet(
            from,
            _modules,
            address(1),
            bytes20(0),
        ...
        bytes4 magicValue = sampleCaller.checkIsValidSignature(
            wallet,
            dataHash,
